<fieldset>
    ...
    <div class="row">
        ...
        <div class="row col-md-6 Ameasurements">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control measurements"  name="measurements"  >
            </div>
        </div>
    </div>
    <br>
    ...
    <div class="row Aweb" style="display:none;">
        <div class="row col-md-12">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control web" name="web">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="row col-md-12">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control zone" name="zona">
            </div>
        </div>
    </div>
    <br>
...
<fieldset>
    ...
    <div class="row">
        <div class="row col-md-12">
            ...
            <div class="col-md-10">
                <textarea class="form-control metatags" rows="3" name="description_metatags"  ></textarea>
            </div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <textarea class="form-control key_words" rows="3" name="key_words"  ></textarea>
            </div>
        </div>
    </div>
</fieldset>
