        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['url' => '/admin/users', 'method' => 'post', 'class' => 'form-horizontal', "enctype" => "multipart/form-data"]) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!!Form::email('email', null, ['class' => 'form-control', 'placeholder' => 'Correo Electronico', 'id' => 'email', 'required' => 'required'])!!}
                        </div>

                        <div class="form-group">
                            <label for="password">{!! trans('label.password') !!}</label>
                            {!!Form::password('password', ['class' => 'form-control', 'placeholder' => 'Contraseña', 'id' => 'pass', 'required' => 'required'])!!}
                        </div>

                        <div class="form-group">
                            <label for="password_confirmation">{!! trans('label.confirm_password') !!}</label>
                            {!!Form::password('password_confirmation', ['class' => 'form-control', 'placeholder' => 'Confirmacion Contraseña', 'id' => 'passVerify', 'required' => 'required'])!!}
                        </div>
