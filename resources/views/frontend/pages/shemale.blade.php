...
<section class="section white">
        <div class="container">
            <div class="big-title text-center">
                <h3>{!! trans('label.shemale') !!}</h3>
                <hr>
                @if(Config::get('app.locale') == 'en')
            <p class="lead">{!! $principal->shemale_des_en !!}</p>
            @else
            <p class="lead">{!! $principal->shemale_des_es !!}</p>
            @endif
            </div><!-- end title -->
        </div><!-- end container -->
    </section><!-- end section --> 
    ...
    <section class="section white">
        <div class="container">
            <div class="big-title text-center">
                <h3>{!! trans('label.shemale') !!} Deluxe</h3>
                <hr>
                @if(Config::get('app.locale') == 'en')
            ...
            <div class="row">
                    ...
                    @foreach($shemaleDelux as $profile)
