    ...
    <section class="section grey">
        <div class="container">
            <div class="row">
                ...
                <?php $tamaÒo = getimagesize($profileSpanish->images->url1); $w = $tamaÒo[0]; $h =$tamaÒo[1] ?>
                
                @if($w <= $h)
                <div class="col-lg-6 col-md-6 col-sm-12 display-principal-image slideInRight">
                    <img src="/{{ $profileSpanish->images->url1 }}" alt="" class="img-fullwidth wow slideInRight img-mw-mh">                
                </div><!-- end col -->
                @else
                 <div class="col-lg-6 col-md-6 col-sm-12 display-principal-image slideInRight">
                    <img src="/{{ $profileSpanish->images->url1 }}" alt="" class="img-fullwidth wow slideInRight img-mw-mh-w">                
                </div><!-- end col -->
                @endif
            </div><!-- end row -->
        </div><!-- end container -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="about-widget">
                        ...
                        <address>
                            ...
                            <strong>Orientaci√≥n sexual:</strong>
